...
public sealed partial class ChamberMagazineAmmoProviderComponent : MagazineAmmoProviderComponent
{
    ...
    public SoundSpecifier? BoltClosedSound = new SoundPathSpecifier("/Audio/_Stalker/Weapons/Guns/RifleGen/Bolt/rifle_bolt_closed.ogg");

    [ViewVariables(VVAccess.ReadWrite), DataField("soundBoltOpened"), AutoNetworkedField]
    public SoundSpecifier? BoltOpenedSound = new SoundPathSpecifier("/Audio/_Stalker/Weapons/Guns/RifleGen/Bolt/rifle_bolt_open.ogg");

    [ViewVariables(VVAccess.ReadWrite), DataField("soundRack"), AutoNetworkedField]
    public SoundSpecifier? RackSound = new SoundPathSpecifier("/Audio/_Stalker/Weapons/Guns/RifleGen/Cock/rifle_cock.ogg");
}
