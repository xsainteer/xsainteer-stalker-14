job-anomalist = Аномалист
job-anomalist-desc = Изучение и сохранение зоны. Активное использование аномалий и артефактов. Создание новых аномалий и артефактов. Создание аппаратуры на основе аномалий/артефактов или для работы с аномалиями.
job-anomalist-guardian = Хранитель
job-anomalist-guardian-desc = Изучение и сохранение зоны. Активное использование аномалий и артефактов. Создание новых аномалий и артефактов. Создание аппаратуры на основе аномалий/артефактов или для работы с аномалиями.
job-anomalist-supervisor = Вы работаете сами на себя
...
job-monolith-desc = Символ тихого, но пугающего присутствия.
job-monolith-supervisor = служите Его голосу
...
job-Opolchenec = Боец ополчения
job-opolchenec-desc = Сталкерское ополчение.
job-opolchenec-supervisor = Вы подчиняетесь своему лидеру.