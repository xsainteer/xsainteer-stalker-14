...
alerts-chem-caustic-name = [color=lightgreen]Химическая опасность[/color]
alerts-chem-caustic-desc = Необходимо покинуть [color=lightgreen]зону поражения,[/color] или надеть химическую защиту.
