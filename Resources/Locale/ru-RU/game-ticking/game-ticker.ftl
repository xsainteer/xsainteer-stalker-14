...
game-ticker-player-join-game-message = Добро пожаловать в Зону Отчуждения! Если вы играете впервые, обязательно нажмите ESC на клавиатуре и прочитайте правила игры, а также не бойтесь просить помощи в "Админ помощь".
game-ticker-get-info-text =
    Здравствуй, рады видеть тебя на проекте [color=white]Stalker 14![/color]
...
game-ticker-get-info-preround-text =
    Привет и добро пожаловать на проект [color=white]Stalker 14![/color]
    Текущий раунд: [color=white]#{ $roundId }[/color]
...
latejoin-arrival-sender = Зоны Отчуждения
latejoin-arrivals-direction = Вскоре прибудет грузовик, который доставит вас на большую землю.
latejoin-arrivals-direction-time = Грузовик, который доставит вас в Зону Отчуждения, прибудет через { $time }.
