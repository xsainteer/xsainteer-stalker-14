...
hugging-success-generic-target = { CAPITALIZE($user) } окликнул(а) вас.
...
# STALKER
comp-fence-knock = *бум*
petting-success-generic-rp74 = Вы гладите { $target }.
petting-failure-generic-rp74 = Вы тянетесь погладить, но { $target } уклоняется от вашего прикосновения.
