...
health-analyzer-window-damage-group-Anomaly = Аномальные
health-analyzer-window-damage-type-Psy = Пси
health-analyzer-window-damage-type-Compression = Сдавливание
